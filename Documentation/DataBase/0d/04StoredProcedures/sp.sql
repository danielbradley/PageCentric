...
return EXISTS( SELECT * FROM statistics_visits WHERE ip_address=$ip_address );
...
SELECT COUNT(*) INTO $count FROM statistics_visits WHERE DATE_SUB( NOW(), INTERVAL $days DAY ) < first_visit;
