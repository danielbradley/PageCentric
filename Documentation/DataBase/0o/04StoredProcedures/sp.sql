...
IF @@read_only THEN
    ...
    SELECT "ERROR" AS status, "READ_ONLY" AS message;
...
#ELSE
#
#   SELECT log_error( "Database is read only!!!" );
...
ELSE
    ...
    ELSE
        ...
        SELECT "ERROR" AS status, "INVALID_AUTHORISATION" AS message;
...
ELSE
	...
	SELECT "ERROR" AS status, "No hashed_id specified" AS message;

#	SELECT * FROM articles_info LIMIT $limit OFFSET $offset;
